...
namespace Efergy3
{
    public partial class Produkti : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (var context = new Efergy3DataContext(connString))
            {
                ...
                bList = data.Select(m => new ProductModel
                {
                    productid = m.productid,
                    proname = m.proname,
                    rating = m.rating,
                ...
                repeaterProdukti2.DataSource = bList;
                repeaterProdukti2.DataBind();
            }
            ...
            using (var context = new Efergy3DataContext(connString))
            {
                ...
                repeaterProdukti3.DataSource = bList;
                repeaterProdukti3.DataBind();
            }
