<%@ Page Title="Автоматска контрола" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AvtomatskaKontrola.aspx.cs" Inherits="Efergy3.AavtomatskaKontrola" %>
        ...
        <div class="area2">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li class="category77">
                        <strong>Автоматска контрола</strong>
                    </li>
                </ul>
            </div>
...
//                $j('.fancybox').fancybox();
        ...
        function calculateShipping(){
            ...
            var url = 'http://efergy.com/uk/calculateshipping/index/calculate/id/77/';
