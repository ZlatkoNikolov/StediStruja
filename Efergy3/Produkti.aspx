<%@ Page Title="Продукти" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Produkti.aspx.cs" Inherits="Efergy3.Produkti" %>
    ...
    <div class="area2-container">
        <div class="area2">
            <div class="breadcrumbs">
                <ul>
                    <li class="home">
                        <a href="Default.aspx" title="Оди на почетна">Почетна</a>
                        <span>/ </span>
                    </li>
                    <li class="category12">
    ...
    <div class="main-container col2-left-layout">
        <div class="main">
            <div class="col-main2">
                ...
                <p class="category-image2">
                    <img src="Images/Produkti/1million_6_1.png" alt="Products" title="Products">
                </p>
                ...
                <div class="category-products">
                    ...
                    <asp:Repeater ID="repeaterProdukti" runat="server">
                        <HeaderTemplate>
                            ...
                            <div class="">
                                <a href="AvtomatskaKontrola.aspx">
                                <h1 class="cattitle">Автоматска контрола</h1>
                                    </a>
                            ...
                            <div class="">
                                ...
                                <button type="button" title="Add to Cart" class="button btn-cart" onclick="setLocation('http://efergy.com/uk/checkout/cart/add/uenc/aHR0cDovL2VmZXJneS5jb20vdWsvcHJvZHVjdHM,/product/220/form_key/uO7C9VpSeS1Lpe19/')"><span><span>Додади</span></span></button>
                                        ...
                                        <ul class="add-to-links">
                                            ...
                                            <li><span class="separator">|</span> <a href='<%#Eval("detaliProduct") %>' class="link-compare">Види продукт</a></li>
                                        </ul>
                                    </li>
                    ...
                    <a href="EliteMonitoring.aspx">
                    <h1 class="cattitle">Elite Мониторинг</h1>
                    </a>
                    <asp:Repeater ID="repeaterProdukti2" runat="server">
                        <HeaderTemplate>
                    ...
                    <a href="OnlineMonitoring.aspx">
                    <h1 class="cattitle">Online Мониторинг</h1>
                        </a>
                    <asp:Repeater ID="repeaterProdukti3" runat="server">
                        <HeaderTemplate>
...
//                $j('.fancybox').fancybox();
        ...
        function calculateShipping(){
            ...
            var url = 'http://efergy.com/uk/calculateshipping/index/calculate/id/12/';
        ...
        //]]>
            ...
            <div class="col-left sidebar">
                ...
                <%--<div class="block block-cart">
                    ...
                    <div class="block-content">
                        <div class="summary">
                            <p class="amount">There is <a href="http://efergy.com/uk/checkout/cart/">1 item</a> in your cart.</p>
                            <p class="subtotal">
                                <span class="label">Cart Subtotal:</span> <span class="price">£54.95</span>
                            </p>
                        </div>
                        <div class="actions">
                            <a id="ec_shortcut_3fb3d3a4412d33fc912f28e0d7968041" href="http://efergy.com/uk/paypal/express/start/">
                            ...
                            <button type="button" title="Checkout" class="button" onclick="setLocation('http://efergy.com/uk/firecheckout/')"><span><span>Checkout</span></span></button>
                        </div>
                        <p class="block-subtitle">Recently added item(s)</p>
                        <ol id="cart-sidebar" class="mini-products-list">
                            <li class="item last odd">
                                <a href="http://efergy.com/uk/e2-classic-2-0" title="e2 classic 2.0" class="product-image">
                                    <img src="Images/Produkti/e2_group_1_9.jpg" width="50" height="50" alt="e2 classic 2.0"></a>
                                <div class="product-details">
                                    <a href="http://efergy.com/uk/checkout/cart/delete/id/26814/uenc/aHR0cDovL2VmZXJneS5jb20vdWsvcHJvZHVjdHM,/" title="Remove This Item" onclick="return confirm('Are you sure you would like to remove this item from the shopping cart?');" class="btn-remove">Remove This Item</a>
                                    <p class="product-name"><a href="http://efergy.com/uk/e2-classic-2-0">e2 classic 2.0</a></p>
                                    <strong>1</strong> x
                ...
                <div class="block block-layered-nav">
                    ...
                    <div class="block-content">
                        <dl id="narrow-by-list2">
                            <dt class="last odd">Категорија</dt>
                            <dd class="last odd">
                                <ol>
                                    <li>
                                        <a href="AvtomatskaKontrola.aspx">Автоматска контрола</a> (1)
                                    </li>
                                    <li>
                                        <a href="EliteMonitoring.aspx">Elite Мониторинг</a> (4)
                                    </li>
                                    <li>
                                        <a href="OnlineMonitoring.aspx">Online мониторинг</a> (5)
                                    </li>
                                    <li>
                                        <a href="Dodatoci.aspx">Додатоци</a> (0)
                                    </li>
