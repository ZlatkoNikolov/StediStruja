<%@ Page Title="Elite Мониторинг" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EliteMonitoring.aspx.cs" Inherits="Efergy3.EliteMonitoring" %>
        ...
        <div class="area2">
            <div class="breadcrumbs">
                <ul>
                    ...
                    <li class="category77">
                        <strong>Elite Мониторинг</strong>
                    </li>
                </ul>
            </div>
...
//                $j('.fancybox').fancybox();
        ...
        function calculateShipping(){
            ...
            var url = 'http://efergy.com/uk/calculateshipping/index/calculate/id/14/';
